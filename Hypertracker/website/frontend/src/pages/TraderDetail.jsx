        ...
        try {
            ...
            const merged = {
                ...
                ...(liveData && !liveData.error ? {
                    ...
                    spot_account_value:   liveData.spot_account_value,
                    perp_account_value:   liveData.perp_account_value,
                    spot_balances:        liveData.spot_balances ?? [],
                    data_source:          'live',
                } : { data_source: 'cached' })
            };
                ...
                <div className={styles.card}>
                    ...
                    <div className={styles.metricGrid}>
                        ...
                        {dataSource === 'live' && (
                            <>
                                <div className={styles.metric}>
                                    <span className={styles.metricLabel}>Perp Value</span>
                                    <span className={styles.metricValue}>
                                        {formatBalance(trader.perp_account_value ?? 0)}
                                    </span>
                                </div>
                                <div className={styles.metric}>
                                    <span className={styles.metricLabel}>Spot Value</span>
                                    <span className={styles.metricValue}>
                                        {formatBalance(trader.spot_account_value ?? 0)}
                                    </span>
                                </div>
                            </>
                        )}
